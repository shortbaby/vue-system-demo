...
( function( root, factory ) {
    ...
    //     define( 'calendar', [ 'zepto' ], function( $ ) {
    //         return factory( root, $ );
    //     } );
    // } else {
    ...
    $.extend( calendar.prototype, {
        ...
        _initEvent: function() {
            ...
            this.el.delegate( 'ul.day li', 'click', function( event ) {
                ...
                if ( !curItem.hasClass( 'iv' ) ) {
                    if ($.type(config.afterSelectDate) === 'function') {
                       
                        config.afterSelectDate.call(me, {
                            date: date,
                            dateName: dateName,
                            curItem: curItem
                        });
                    }
                    // me.el.trigger('afterSelectDate', [ {
                    //     date: date,
                    //     dateName: dateName,
                    //     curItem: curItem
                    // } ] );
        ...
        setSelectDate: function( date ) {
            ...
            //先移到上次选中日期高亮
            // debugger;
            if ( lastSltItem.length && config.select == 'single') {
            ...
            if ( curSltItem.length ) {
                ...
                if (config.select =='multiple' && curSltItem.hasClass("cur")) {
                    curSltItem.removeClass( 'cur' );
                    if ( !curSltItem.hasClass( 'jr' ) ) {
                        curSltItem.removeClass( 'dl' );
                        curDateNameEl.text( '' );
                    }
                    return;
                } 
